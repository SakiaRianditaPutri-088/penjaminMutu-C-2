...
function LoginForm() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifyLogin"])(email, password);
            if (!user) {
            ...
            setError(err.message || (language === "id" ? "Login gagal. Silakan coba lagi." : "Login failed. Please try again."));
        } finally{
            setIsLoading(false);
        }
    };
    const handleRegister = async (e)=>{
        ...
        try {
            ...
            const newUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerAccount"])(email, password, name);
            if (!newUser) {
            ...
            setError(err.message || (language === "id" ? "Registrasi gagal. Silakan coba lagi." : "Registration failed. Please try again."));
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6fc5014._.js.map