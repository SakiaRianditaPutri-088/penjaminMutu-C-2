...
function LoginForm() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].login(email, password);
            // Store user data
            const userData = {
                id: response.user.id,
    ...
    const handleRegister = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].register(email, password, name);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4936b7cf._.js.map