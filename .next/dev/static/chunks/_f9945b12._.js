...
class ApiClient {
    ...
    async getTasksByCourse(courseId) {
        return this.request(`/courses/${courseId}/tasks`);
    }
    ...
    async getTaskStatuses() {
        return this.request('/lookups/task-statuses');
    }
    async getTaskPriorities() {
        return this.request('/lookups/task-priorities');
    }
}
...
function LoginForm() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].login(email, password);
            // Store user data
            const userData = {
                id: response.user.id,
    ...
    const handleRegister = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].register(email, password, name);
...
//# sourceMappingURL=_f9945b12._.js.map